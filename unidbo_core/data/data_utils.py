...
def filter_topk_roadgraph_points(roadgraph, reference_points, topk):
    """
    Returns the top-k closest roadgraph points to a query point.
    ...
    Args:
        ...
        reference_points: A tensor of shape (..., 2) used to measure distance.
        topk: Number of points to keep.

    Returns:
        Roadgraph data structure filtered to only contain the `topk` closest points.
    """
